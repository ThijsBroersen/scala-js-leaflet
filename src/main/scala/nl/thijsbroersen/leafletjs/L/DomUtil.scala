...
object DomUtil extends js.Object {
  ...
  def create(tagName: String,
             ...
             container: js.UndefOr[HTMLElement] = js.undefined): HTMLElement = js.native
  ...
  def testProp(props: js.Array[String]): String | Boolean =
    js.native //from Scala 2.13 onwards the return type can be String | false
  ...
  def getSizedParentNode(el: HTMLElement): HTMLElement                                             = js.native
  def getScale(el: HTMLElement): js.Object                                                         = js.native
}
